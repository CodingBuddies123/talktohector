...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <link href="Content/Carousel-Images-Fix.css" rel="stylesheet" />
                    ...
                    <div class="carousel-caption">
                        ...
                        <div class="item">
                                ...
                                <a href="https://itunes.apple.com/us/podcast/talk-to-hector/id1071746951?mt=2 " target="_blank">
                                    <img src="/images/slide1.png" alt="Alternate Text" <%--height="300" width="800"--%> />
                                    <style>
                                        img {
                                            border-radius: 25px;
                ...
                <div class="container">
                    <div class="carousel-caption">
                        <div class="item">
                            ...
                            <img src="/images/free_advice.png" alt="Alternate Text" height="400" width="400" />
                            <style>
                                img {
                                    border-radius: 25px;
                                    align-content: center;
    ...
    <div class="container marketing">
        <div class="container text-center">
            ...
            <h1><strong>Welcome To Talk To Hector dot Com</strong> </h1><br />
            <p>
            ...
            <p>we can hear, is that of a friend who is willing to listen, pray, and provide a advice.</p>
